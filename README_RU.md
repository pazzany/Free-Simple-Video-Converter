...
Очередь принимает файлы `.mp4`, `.mpg`, `.mpeg`, `.mkv`, `.avi`, `.mov`, `.wmv`, `.asf`, `.wm`, `.wma`, `.flv`, `.webm`, `.m4v`, `.ts`, `.mts`, `.m2ts`, `.m2t`, `.m2v`, `.3gp`, `.vob` и `.ogv`. При добавлении папки программа также находит подходящие файлы во вложенных каталогах.
